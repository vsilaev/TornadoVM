...
public class KernelContextWorkGroupTests extends TornadoTestBase {
    ...
    public void test01() {
        ...
        int[] data = new int[16];
        TaskGraph ts = new TaskGraph("s0").task("t0", KernelContextWorkGroupTests::apiTestGlobalGroupSizeX, context, data).streamOut(data);
        ts.execute(grid);
    ...
    public void test02() {
        ...
        int[] data = new int[16];
        TaskGraph ts = new TaskGraph("s0").task("t0", KernelContextWorkGroupTests::apiTestGlobalGroupSizeY, context, data).streamOut(data);
        ts.execute(grid);
    ...
    public void test03() {
        ...
        int[] data = new int[16];
        TaskGraph ts = new TaskGraph("s0").task("t0", KernelContextWorkGroupTests::apiTestGlobalGroupSizeZ, context, data).streamOut(data);
        ts.execute(grid);
    ...
    public void test04() {
        ...
        TaskGraph ts = new TaskGraph("s0").task("t0", KernelContextWorkGroupTests::apiTestLocalGroupSizeX, context, data).streamOut(data);
        ts.execute(grid);
    ...
    public void test05() {
        ...
        int[] data = new int[1024];
        TaskGraph ts = new TaskGraph("s0").task("t0", KernelContextWorkGroupTests::apiTestLocalGroupSizeY, context, data).streamOut(data);
        ts.execute(grid);
    ...
    public void test06() {
        ...
        int[] data = new int[1024];
        TaskGraph ts = new TaskGraph("s0").task("t0", KernelContextWorkGroupTests::apiTestLocalGroupSizeZ, context, data).streamOut(data);
        ts.execute(grid);
