...
public interface TaskGraphInterface {
    ...
    CompletableFuture<TaskGraphInterface> executeAsync();

    CompletableFuture<TaskGraphInterface> executeAsync(Executor executor);


    CompletableFuture<TaskGraphInterface> executeAsync(GridScheduler gridScheduler);

    CompletableFuture<TaskGraphInterface> executeAsync(GridScheduler gridScheduler, Executor executor);
