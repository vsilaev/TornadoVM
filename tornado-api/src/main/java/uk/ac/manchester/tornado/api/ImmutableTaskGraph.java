...
public class ImmutableTaskGraph {
    ...
    CompletionStage<ImmutableTaskGraph> executeAsync(ExecutorFrame executionPackage, Executor executor) {
        return this.taskGraph.executeAsync(executionPackage, executor)
                             .thenApply(v -> this);
    }
